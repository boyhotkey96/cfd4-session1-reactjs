                ...
                <div className="text">
                  ...
                  <div className="text-item it2">
                    ...
                    <div className="content">
                      ...
                      Sale, chưa biết gì về HTML, CSS, JS, mà giờ code được 1
                      web hoàn chỉnh. Mentor thì hỗ trợ nhiệt tình, lên lớp học
                      lý thuyết xong là thực chiến luôn, về nhà thì livestream
                      sửa bài, có khi tới 1-2h sáng luôn. Sau khoá học thì được
                      các mentor chia sẻ kinh nghiệm.
                    </div>
                    <div className="bottom">
                      <span className="fb">
                        <img src="img/facebook-app-symbol.svg" alt="" />
